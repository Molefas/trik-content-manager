...
export function createCreateContent(storage) {
...
export function createListContent(storage) {
    return tool(async (input) => {
...
export function createGetContent(storage) {
    return tool(async (input) => {
...
export function createUpdateContent(storage) {
    return tool(async (input) => {
