...
export function createFetchNewsletterEmails(storage, config) {
    return tool(async (input) => {
        ...
        try {
            const emails = await fetchEmailsFromSender({ clientId, clientSecret, refreshToken }, source.identifier, {
